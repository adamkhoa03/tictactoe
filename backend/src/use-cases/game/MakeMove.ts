...
import { MakeMoveInput } from '../../schemas/room.schema';

interface MakeMoveParams {
  userId: string;
  roomId: MakeMoveInput['roomId'];
  row: MakeMoveInput['row'];
  col: MakeMoveInput['col'];
}

export class MakeMove {
  constructor(private roomRepository: IRoomRepository) {}

  async execute(params: MakeMoveParams): Promise<Room> {
